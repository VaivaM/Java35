...
public class RegularExpression {
    public static void main(String[] args) {
        ...
        Matcher matcher = (Matcher) pattern.matcher("aaab");
        ...
        System.out.println(Pattern.matches("[a-z5-9]{3}","5x9"));

        //2 Uppercase letters followed by 2 lower case letters and then by 3 numbers
        System.out.println(Pattern.matches("[A-Z]{2}[a-z]{2,}[0-9]{3}","UFjdgdfg923"));
